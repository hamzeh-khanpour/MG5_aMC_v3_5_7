...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL VXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3))  !  count 48
      CALL VXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4))  !  count 48
      CALL VXXXXX(P(0,3),MDL_MW,+1,+1*IC(3),W(1,5))  !  count 26
      CALL VXXXXX(P(0,3),MDL_MW, 0,+1*IC(3),W(1,6))  !  count 26
      CALL VXXXXX(P(0,3),MDL_MW,-1,+1*IC(3),W(1,7))  !  count 26
      CALL VXXXXX(P(0,4),MDL_MW,+1,+1*IC(4),W(1,8))  !  count 26
      CALL VXXXXX(P(0,4),MDL_MW, 0,+1*IC(4),W(1,9))  !  count 26
      CALL VXXXXX(P(0,4),MDL_MW,-1,+1*IC(4),W(1,10))  !  count 26
      CALL VVVV11_3_0(W(1,1),W(1,3),W(1,8),W(1,5),GC_143,GC_144,AMP(24,1
     $))
      CALL VVVV11_3_0(W(1,1),W(1,3),W(1,9),W(1,6),GC_143,GC_144,AMP(23,1
     $))
      CALL VVVV11_3_0(W(1,1),W(1,3),W(1,10),W(1,7),GC_143,GC_144,AMP(22,
     $1))
      CALL VVVV11_3P1N_3(W(1,1), W(1,4), W(1,5), GC_143, GC_144, TMP(1))
      call CombineAmp(3,
     & (/19,20,21/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,1))
      CALL VVVV11_3P1N_3(W(1,1), W(1,4), W(1,6), GC_143, GC_144, TMP(1))
      call CombineAmp(3,
     & (/16,17,18/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,1))
      CALL VVVV11_3P1N_3(W(1,1), W(1,4), W(1,7), GC_143, GC_144, TMP(1))
      call CombineAmp(3,
     & (/13,14,15/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,1))
      CALL VVVV11_3P1N_3(W(1,2), W(1,3), W(1,5), GC_143, GC_144, TMP(1))
      call CombineAmp(3,
     & (/10,11,12/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,1))
      CALL VVVV11_3P1N_3(W(1,2), W(1,3), W(1,6), GC_143, GC_144, TMP(1))
      call CombineAmp(3,
     & (/7,8,9/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,1))
      CALL VVVV11_3P1N_3(W(1,2), W(1,3), W(1,7), GC_143, GC_144, TMP(1))
      call CombineAmp(3,
     & (/4,5,6/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,1))
      CALL VVVV11_3_0(W(1,2),W(1,4),W(1,8),W(1,5),GC_143,GC_144,AMP(3,1)
     $)
      CALL VVVV11_3_0(W(1,2),W(1,4),W(1,9),W(1,6),GC_143,GC_144,AMP(2,1)
     $)
      CALL VVVV11_3_0(W(1,2),W(1,4),W(1,10),W(1,7),GC_143,GC_144,AMP(1,1
     $))  !  count 1
      CALL VVVV7_0(W(1,1),W(1,3),W(1,8),W(1,5),GC_56,AMP(24,2))
      CALL VVVV7_0(W(1,1),W(1,3),W(1,9),W(1,6),GC_56,AMP(23,2))
      CALL VVVV7_0(W(1,1),W(1,3),W(1,10),W(1,7),GC_56,AMP(22,2))
      CALL VVVV7P1N_3(W(1,1), W(1,4), W(1,5), GC_56, TMP(1))
      call CombineAmp(3,
     & (/19,20,21/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,2))
      CALL VVVV7P1N_3(W(1,1), W(1,4), W(1,6), GC_56, TMP(1))
      call CombineAmp(3,
     & (/16,17,18/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,2))
      CALL VVVV7P1N_3(W(1,1), W(1,4), W(1,7), GC_56, TMP(1))
      call CombineAmp(3,
     & (/13,14,15/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,2))
      CALL VVVV7P1N_3(W(1,2), W(1,3), W(1,5), GC_56, TMP(1))
      call CombineAmp(3,
     & (/10,11,12/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,2))
      CALL VVVV7P1N_3(W(1,2), W(1,3), W(1,6), GC_56, TMP(1))
      call CombineAmp(3,
     & (/7,8,9/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,2))
      CALL VVVV7P1N_3(W(1,2), W(1,3), W(1,7), GC_56, TMP(1))
      call CombineAmp(3,
     & (/4,5,6/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,2))
      CALL VVVV7_0(W(1,2),W(1,4),W(1,8),W(1,5),GC_56,AMP(3,2))
      CALL VVVV7_0(W(1,2),W(1,4),W(1,9),W(1,6),GC_56,AMP(2,2))
      CALL VVVV7_0(W(1,2),W(1,4),W(1,10),W(1,7),GC_56,AMP(1,2))  !  count 1
      CALL VVV1_2(W(1,1),W(1,5),GC_50,MDL_MW,ZERO,W(1,11))  !  count 4
      CALL VVV1_2(W(1,1),W(1,6),GC_50,MDL_MW,ZERO,W(1,12))  !  count 4
      CALL VVV1_2(W(1,1),W(1,7),GC_50,MDL_MW,ZERO,W(1,13))  !  count 4
      CALL VVV1_2(W(1,2),W(1,5),GC_50,MDL_MW,ZERO,W(1,14))  !  count 4
      CALL VVV1_2(W(1,2),W(1,6),GC_50,MDL_MW,ZERO,W(1,15))  !  count 4
      CALL VVV1_2(W(1,2),W(1,7),GC_50,MDL_MW,ZERO,W(1,16))  !  count 4
      CALL VVV1P1N_3(W(1,3), W(1,8), GC_50, TMP(1))
      call CombineAmp(4,
     & (/24,10,7,4/), 
     & (/11,14,15,16/),
     & TMP, W, AMP(1,3))
      CALL VVV1P1N_3(W(1,3), W(1,9), GC_50, TMP(1))
      call CombineAmp(4,
     & (/23,11,8,5/), 
     & (/12,14,15,16/),
     & TMP, W, AMP(1,3))
      CALL VVV1P1N_3(W(1,3), W(1,10), GC_50, TMP(1))
      call CombineAmp(4,
     & (/22,12,9,6/), 
     & (/13,14,15,16/),
     & TMP, W, AMP(1,3))
      CALL VVV1P1N_3(W(1,4), W(1,8), GC_50, TMP(1))
      call CombineAmp(4,
     & (/19,16,13,3/), 
     & (/11,12,13,14/),
     & TMP, W, AMP(1,3))
      CALL VVV1P1N_3(W(1,4), W(1,9), GC_50, TMP(1))
      call CombineAmp(4,
     & (/20,17,14,2/), 
     & (/11,12,13,15/),
     & TMP, W, AMP(1,3))
      CALL VVV1P1N_3(W(1,4), W(1,10), GC_50, TMP(1))
      call CombineAmp(4,
     & (/21,18,15,1/), 
     & (/11,12,13,16/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL VVV1_3(W(1,1),W(1,8),GC_50,MDL_MW,ZERO,W(1,17))  !  count 4
      CALL VVV1_3(W(1,1),W(1,9),GC_50,MDL_MW,ZERO,W(1,18))  !  count 4
      CALL VVV1_3(W(1,1),W(1,10),GC_50,MDL_MW,ZERO,W(1,19))  !  count 4
      CALL VVV1_3(W(1,2),W(1,8),GC_50,MDL_MW,ZERO,W(1,20))  !  count 4
      CALL VVV1_3(W(1,2),W(1,9),GC_50,MDL_MW,ZERO,W(1,21))  !  count 4
      CALL VVV1_3(W(1,2),W(1,10),GC_50,MDL_MW,ZERO,W(1,22))  !  count 4
      CALL VVV1P1N_2(W(1,3), W(1,5), GC_50, TMP(1))
      call CombineAmp(4,
     & (/24,10,11,12/), 
     & (/17,20,21,22/),
     & TMP, W, AMP(1,4))
      CALL VVV1P1N_2(W(1,3), W(1,6), GC_50, TMP(1))
      call CombineAmp(4,
     & (/23,7,8,9/), 
     & (/18,20,21,22/),
     & TMP, W, AMP(1,4))
      CALL VVV1P1N_2(W(1,3), W(1,7), GC_50, TMP(1))
      call CombineAmp(4,
     & (/22,4,5,6/), 
     & (/19,20,21,22/),
     & TMP, W, AMP(1,4))
      CALL VVV1P1N_2(W(1,4), W(1,5), GC_50, TMP(1))
      call CombineAmp(4,
     & (/19,20,21,3/), 
     & (/17,18,19,20/),
     & TMP, W, AMP(1,4))
      CALL VVV1P1N_2(W(1,4), W(1,6), GC_50, TMP(1))
      call CombineAmp(4,
     & (/16,17,18,2/), 
     & (/17,18,19,21/),
     & TMP, W, AMP(1,4))
      CALL VVV1P1N_2(W(1,4), W(1,7), GC_50, TMP(1))
      call CombineAmp(4,
     & (/13,14,15,1/), 
     & (/17,18,19,22/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
        JAMP(1,1) = AMP( K,1)+AMP( K,2)+AMP( K,3)+AMP( K,4)
