...
C     Amplitude(s) for diagram number 1
      CALL VVVV11_3_0(W(1,1),W(1,2),W(1,4),W(1,3),GC_143,GC_144,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL VVVV7_0(W(1,1),W(1,2),W(1,4),W(1,3),GC_56,AMP(2))
      CALL VVV1_2(W(1,1),W(1,3),GC_50,MDL_MW, ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,2),W(1,4),W(1,5),GC_50,AMP(3))
      CALL VVV1_3(W(1,1),W(1,4),GC_50,MDL_MW, ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL VVV1_0(W(1,2),W(1,5),W(1,3),GC_50,AMP(4))
